...
class LLMPort(Protocol):
    """Port interface abstracting communication with an LLM backend."""
...
class FileSystemPort(Protocol):
    """Port interface abstracting file system operations."""

    def read_text(self, path: Path) -> str: ...
    def write_text(self, path: Path, content: str) -> None: ...
    def list_files(self, root: Path, extensions=None, ignore_dirs=None) -> List[Path]: ...
